...
| CI/CD([Azure DevOps](template/{{.input_root_dir}}/.azure/))                       |  [Azure DevOps](https://azure.microsoft.com/en-us/products/devops) workflows to test and deploy ML code and resources | Ship ML code faster and with confidence: ensure all production changes are performed through automation and that only tested code is deployed to prod                                   |
 ...
 * ``input_cicd_platform`` : Azure DevOps.
